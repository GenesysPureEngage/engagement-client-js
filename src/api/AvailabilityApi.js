...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @param {Date} opts.start Start date in ISO 8601 format, using UTC as timezone: YYYY-MM-ddTHH:mm:ssZ. If not specified, the start date is assumed to be now.
     ...
     * @param {String} serviceName Name of the callback execution service provisioned in GES.
     * @param {Object} opts Optional parameters
     * @param {Date} opts.start Start date in ISO 8601 format, using UTC as the timezone: yyyy-MM-ddTHH:mm:ss.SSSZ. If not specified, the start date is assumed to be now.
     ...
     * @param {Date} opts.end End date in ISO 8601 format, using UTC as timezone: yyyy-MM-ddTHH:mm:ss.SSSZ. If neither end nor numberOfDays is specified, the end date is assumed to be the start date.
