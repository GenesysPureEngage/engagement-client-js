...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @param {String} opts.cacheControl max-age&#x3D;15 - Acceptable maximum age of cached data specified in seconds. If cached data available is older than the max-age specified, then a query to GWS statistics is performed. Default is 15 seconds.
