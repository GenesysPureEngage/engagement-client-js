...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CallbackAndRelatedApIs.CreateCallbackParms = factory(root.CallbackAndRelatedApIs.ApiClient);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('pushChannel')) {
        obj['pushChannel'] = ApiClient.convertToType(data['pushChannel'], 'String');
      }
      if (data.hasOwnProperty('pushTarget')) {
        obj['pushTarget'] = ApiClient.convertToType(data['pushTarget'], 'String');
      }
    }
    return obj;
  }
  ...
  /**
   * The push channel to receive a push notification when the serviceName provided is configured to be USERORIGINATED. Otherwise this is ignored. Currently only supports a value of 'FCM'.
   * @member {String} pushChannel
   */
  exports.prototype['pushChannel'] = undefined;
  /**
   * The push target to receive a push notification when the serviceName provided is configured to be USERORIGINATED. Otherwise this is ignored.
   * @member {String} pushTarget
   */
  exports.prototype['pushTarget'] = undefined;
